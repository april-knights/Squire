...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/battalion/{alias}/edit', 'BattalionController@edit');       # NEW
    Route::post('/battalion/{alias}/edit', 'BattalionController@update');    # NEW
    Route::delete('/battalion/{alias}', 'BattalionController@destroy');      # NEW
