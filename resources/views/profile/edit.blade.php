                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="batt">
                                    @php /** @var \App\Models\Battalion $batt */ @endphp
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="rank">
                                    @php /** @var \App\Models\Rank $rank */ @endphp
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="security">
                                    @php /** @var \App\Models\Security $sec */ @endphp
                    ...
                    @if (in_array('divs', $editable_fields))
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <fieldset name="divs">
                                    @php /** @var \App\Models\Division $div */ @endphp
                                    @php /** @var \Illuminate\Support\Collection $cur_divs */ @endphp
                                    @foreach ($all_divs as $div)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="divs[]"
                                                   id="div_{{ $div->pkey }}"
                                                   value="{{ $div->pkey }}"
                                                   @if ($cur_divs->contains($div)) checked @endif>
                            ...
                            <div class="form-group">
                                ...
                                <fieldset name="firstevent">
                                    @foreach ($all_events as $event)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="firstevent"
                                                   id="event_{{ $event->pkey }}"
                                                   value="{{ $event->pkey }}"
                                                   @if ($event->pkey == $knight->firstevent) checked @endif>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="bio" name="bio"
                                      maxlength="255">{{ $knight->bio }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="rlimpact">Real Life</label>
                            <textarea class="form-control" id="rlimpact" name="rlimpact"
                                      maxlength="255">{{ $knight->rlimpact }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="skills[]" multiple size="28">
                        @php
                            $in_group = false;
                        @endphp
                        @php /** @var \App\Models\Skill $skill */ @endphp
                ...
                <div class="col">
                    <div class="form-group">
                        <button type="submit" class="btn btn-danger float-left" form="delete" data-toggle="confirmation"
                                data-btn-ok-icon-class="fas fa-check" data-btn-cancel-icon-class="fas fa-ban">Delete
                            user
                        </button>
                    </div>
                </div>
