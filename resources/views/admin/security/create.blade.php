{{--
    CREATE BLADE — save as resources/views/admin/security/create.blade.php
--}}
@extends('layouts.app')
@section('title', 'Admin — New Security Profile')
...
<h2 class="mb-3">New Security Profile</h2>
...
<form method="POST" action="/admin/security">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control @error('secname') is-invalid @enderror"
                           id="secname" name="secname" value="{{ old('secname') }}" required maxlength="30">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control @error('secdescr') is-invalid @enderror"
                           id="secdescr" name="secdescr" value="{{ old('secdescr') }}" maxlength="255">
    ...
    <div class="form-group row">
        <div class="col-sm-9 offset-sm-3">
            ...
            <a href="/admin/security" class="btn btn-outline-secondary ml-2">Cancel</a>
        </div>
    </div>
