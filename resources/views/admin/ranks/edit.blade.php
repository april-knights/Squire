@extends('layouts.app')
@section('title', 'Admin — Edit ' . $rank->name)
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/admin/ranks/{{ $rank->pkey }}">{{ $rank->name }}</a></li>
        <li class="breadcrumb-item active">Edit</li>
    </ol>
</nav>

<h2 class="mb-3">Edit Rank — {{ $rank->name }}</h2>

<form method="POST" action="/admin/ranks/{{ $rank->pkey }}/edit">
    @csrf
    @method('PUT')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                           id="name" name="name" value="{{ old('name', $rank->name) }}" required maxlength="20">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input type="number" class="form-control @error('rval') is-invalid @enderror"
                           id="rval" name="rval" value="{{ old('rval', $rank->rval) }}" required min="1" max="99">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control @error('rankdescr') is-invalid @enderror"
                           id="rankdescr" name="rankdescr" value="{{ old('rankdescr', $rank->rankdescr) }}" maxlength="255">
    ...
    <div class="form-group row">
        <div class="col-sm-9 offset-sm-3">
            ...
            <a href="/admin/ranks/{{ $rank->pkey }}" class="btn btn-outline-secondary ml-2">Cancel</a>
        </div>
    </div>
